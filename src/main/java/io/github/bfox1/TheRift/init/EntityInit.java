...
public class EntityInit
{
    ...
    {
        EntityRegistry.registerModEntity(new ResourceLocation("Rift Creeper"), EntityRiftCreeper.class, "rift_creeper", 1, TheRift.instance, 30, 3, true, 1,2);
        //EntityRegistry.registerModEntity(EntityRiftSpecialPlayer.class, "player", 2, TheRift.instance, 40, 3, true, 2, 4);
    }
